...
<body>
	...
	<form action="/AutoHome/servlet/UpdateRoleServlet" method="post">
		<table class="maintable" width="100%" border="0" cellspacing="0">
			<tr>
				<td width="104"><div align="right">角色编号：</div></td>
				<td height="24" colspan="2"><input type="text"
					readonly="true" value="${roleInfo.rID}" name="rID"/></td>

			</tr>
			<tr>
				<td width="104"><div align="right">角色名称：</div></td>
				<td width="239" height="24"><input name="roleName"
					value="${roleInfo.rName}" type="text" class="inputcontent"
					id="roleName" size="20"></td>
				<td width="435"></td>
			</tr>
			<tr>
				<td width="104"><div align="right">角色描述：</div></td>
				<td height="24"><textarea name="roleDepict" id="roleDepict">${roleInfo.rDesc}</textarea></td>
				<td height="24"></td>
			</tr>
			<tr>
